...
/**
 * This class supports output of graphical objects like points, lines, circles and rectangles in
 * as static window. The class provides a set of methods as follows:
 * <ul>
 *   <li> The method open initializes the class, creates a window and opens it. </li>
 *   <li> Methods drawPoint, drawLine, drawCircle and drawRectangle will draw points,
 *   lines, circles and rectangles respectively.
 *   Further, there are overloaded methods which also take a further color parameter to
 *   draw the objects in the given color. </li>
 *   <li> Then methoden fillCircle und fillRectangle will draw rectangles and circles filled
 *   with the given color. </li>
 * </ul>
 *
...
public class Window {
     ...
     * Default font
     */
    private static final Font DEFAULT_FONT = new Font("Courier", Font.PLAIN, 14);
...
// open
    ...
    /**
     * Computes the text width for displaying the text with the default font.
     *
     * @param text the text string
     * @return the text width in the default font
     */
    public static int textWidth(String text) {
        AffineTransform affinetransform = new AffineTransform();
        FontRenderContext frc = new FontRenderContext(affinetransform, true, true);
        return (int) (DEFAULT_FONT.getStringBounds(text, frc).getWidth());
    }

    /**
     * Computes the text height for displaying the text with the default font.
     *
     * @param text the text string
     * @return the text height in the default font
     */
    public static int textHeight(String text) {
        AffineTransform affinetransform = new AffineTransform();
        FontRenderContext frc = new FontRenderContext(affinetransform, true, true);
        return (int) (DEFAULT_FONT.getStringBounds(text, frc).getHeight());
    }
...
// Methods for drawing 
    ...
    /**
     * Draws a line from a given coordinates x1/y1 to coordinates x2/y2  with given color.
     *
     * @param x1    the x-coordinate for the first point
     * @param y1    the y-coordinate for the first point
     * @param x2    the x-coordinate for the second point
    ...
    /**
     * Draws the image with the left upper corner on position x/y
     *
...
// private section --------------------------------------------------------------------------------
    ...
    /**
     * Panel with content; is of type WindowOPanel, which draws into a BufferedImage image
     */
    private static WindowOPanel contentPane;

    /**
     * BufferedImage is the image where all the draw operations are done and which is displayed by WindowOPanel
     */
    ...
    /**
     * Inner class for doing the painting.
     * Method paint is overridden and draws the content of the BufferedImage.
     */
